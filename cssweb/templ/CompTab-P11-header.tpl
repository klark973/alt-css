...
<title>Совместимость с дистрибутивами Альт на одиннадцатой платформе</title>
...
<li>«<b>Альт Сервер виртуализации 11</b>» (x86_64 и aarch64) — см. колонку «<b>Альт Сервер 11</b>».</li>
</ol>

<p class="notes">Совместимость с дистрибутивами Альт на <b>десятой платформе</b> представлена в другой
