...
<title>Совместимость с дистрибутивом Simply Linux 11</title>
...
<td><h1>Совместимость с дистрибутивом Simply Linux 11</h1>
...
<p class="notes">Мы считаем, что совместимость ПО с <b>Simply Linux 11</b> и другими
   дистрибутивами на одниннадцатой платформе, скорее всего, <a href="P11-view2.html">идентична</a>.
